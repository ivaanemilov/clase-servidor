...
public final class Usuario implements Serializable {
    ...
    public Usuario(int id,
        ...
        if (UtilesUsuarios.validarId(perfil)) {
            this.perfil = perfil;
        } else {
    ...
    public void setPerfilInfo(String perfil) {
    ...
    public int hashCode() {
        ...
        hash = 83 * hash + Objects.hashCode(this.avatar);
        hash = 83 * hash + this.perfil;
        hash = 83 * hash + Objects.hashCode(this.perfilInfo);
        return hash;
    }
